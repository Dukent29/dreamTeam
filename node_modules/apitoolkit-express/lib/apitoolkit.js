...
exports.findMatchedRoute = exports.APIToolkit = void 0;
...
class APIToolkit {
    ...
    expressMiddleware(req, res, next) {
        if (__classPrivateFieldGet(this, _APIToolkit_project_id, "f") === undefined) {
        ...
        apitoolkit_js_1.asyncLocalStorage.run(new Map(), () => {
            ...
            const onRespFinished = (topic, req, res) => (_err) => {
                ...
                const ignoredRoute = __classPrivateFieldGet(this, _APIToolkit_config, "f").ignoreEndpoints?.some((e) => {
